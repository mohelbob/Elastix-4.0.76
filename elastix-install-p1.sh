...
if [ -e Elastix-4.0.76-Stable-x86_64-bin-05Sep2016.iso ]; then
	echo "ISO is already avalible. Skipping download"
else
	wget http://196.216.167.198/pub4/sourceforge/v/va/vaak/Elastix/4/Elastix-4.0.76-Stable-x86_64-bin-05Sep2016.iso
fi
...
7z x -o/mnt/iso/ Elastix-4.0.76-Stable-x86_64-bin-05Sep2016.iso
sleep 1
...
echo "About to install Elaxtix 4.0.76-Stable-x86_64. You have 5 seconds to press CTRL-C to abort."
sleep 5
